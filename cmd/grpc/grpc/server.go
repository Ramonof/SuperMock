...
func (s *Server) handleStream(t transport.ServerTransport, stream *transport.ServerStream) {
	...
	//if service == "helloworld.Greeter" {
	//	md := &MethodDesc{
	//		MethodName: "SayHello",
	//		Handler:    _DataBase_Method_Handler,
	//	}
...
func _DataBase_Method_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor UnaryServerInterceptor) (interface{}, error) {
	in := &map[string]any{}
	if err := dec(in); err != nil {
		return nil, err
	}
	return DoTheThing(ctx, in)
}

func DoTheThing(ctx context.Context, in *map[string]any) (map[string]any, error) {
	return map[string]any{"Message": "Hello " + "Placeholder"}, nil
}
